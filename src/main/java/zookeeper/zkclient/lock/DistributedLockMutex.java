 ...
 *
 */
public class DistributedLockMutex extends BaseDistributeLock implements DistributeLock{
	...
	public void release() throws Exception {
		...
		LockData lockData = threadData.get(currentThread);
		if(lockData==null){
			throw new IllegalMonitorStateException("你不是锁:'"+basePath+"'的拥有着,无法执行此操作!");
		}
